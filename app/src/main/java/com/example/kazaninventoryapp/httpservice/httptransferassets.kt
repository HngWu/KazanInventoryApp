...
class httptransferassets {
    fun postAsset(asset: TransferAsset, onSuccess: (Boolean) -> Unit, onFailure: (Throwable) -> Unit) {


        val url = URL("http://10.0.2.2:5232/api/Asset/transfer")
        try {
